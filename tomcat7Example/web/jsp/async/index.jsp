...
1. Simple dispatch
 ...
 - background thread calls ctx.dispatch()
   <a href="<%=response.encodeURL("/async/async0")%>"> Async 0 </a>

2. Simple dispatch
 - servlet does startAsync()
 - background thread calls dispatch(/path/to/jsp)
   <a href="<%=response.encodeURL("/async/async1")%>"> Async 1 </a>

3. Simple dispatch
 - servlet does startAsync()
 - background thread calls writes and calls complete()
   <a href="<%=response.encodeURL("/async/async2")%>"> Async 2 </a>

4. Simple dispatch
 - servlet does a startAsync()
 - servlet calls dispatch(/path/to/jsp)
 - servlet calls complete()
   <a href="<%=response.encodeURL("/async/async3")%>"> Async 3 </a>
...
7. Stock ticker
   <a href="<%=response.encodeURL("/async/stockticker")%>"> StockTicker </a>
</pre>